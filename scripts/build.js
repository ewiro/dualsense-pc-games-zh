...
for (const file of ['index.html', 'styles.css', 'light.css', 'app.js', 'tester.html', 'tester.css', 'tester.js', 'tester-lib.js', 'haptics-audio.js', '404.html']) await cp(resolve(root, file), resolve(dist, file));
